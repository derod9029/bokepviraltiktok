...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepviraltiktok.pages.dev/v/${file.filecode}#${file.title}`,
